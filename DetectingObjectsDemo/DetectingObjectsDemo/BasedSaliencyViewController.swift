//
//  BasedSaliencyViewController.swift
    ...
    private lazy var attentionRequest: VNGenerateAttentionBasedSaliencyImageRequest = {
        let request = VNGenerateAttentionBasedSaliencyImageRequest { request, error in
            DispatchQueue.main.async {
                self.drawTask(request: request as! VNGenerateAttentionBasedSaliencyImageRequest)
            }
        }
        return request
    }()
    
    private func drawTask(request: VNGenerateAttentionBasedSaliencyImageRequest) {
